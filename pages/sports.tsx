...
const sports: React.FC<sportsProps> = ({ newsData }) => {
...
export async function getServerSideProps() {
  ...
  const API_ENDPOINT = `https://newsapi.org/v2/top-headlines?country=in&apiKey=${API_KEY}&category=sports&pageSize=100`;
